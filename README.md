...
`index.html` 을 fork 후 **두 곳**의 `GTM-KFQ8MHH9` 를 본인 컨테이너 ID로 교체:

```html
})(window,document,'script','dataLayer','GTM-KFQ8MHH9');  // ← 여기

<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KFQ8MHH9" ...>  // ← 여기
```
